...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="slider-three">
            <img src="/assets_homepage/assets/images/slider-3-icon-1-1.png" class="slider-three__icon-1" alt="">
            <img src="/assets_homepage/assets/images/slider-3-icon-1-2.png" class="slider-three__icon-2" alt="">
            <img src="/assets_homepage/assets/images/slider-3-icon-1-3.png" class="slider-three__icon-3" alt="">
            <img src="/assets_homepage/assets/images/slider-3-icon-1-4.png" class="slider-three__icon-4" alt="">
            <img src="/assets_homepage/assets/images/slider-3-icon-1-5.png" class="slider-three__icon-5" alt="">
            <div class="container">
                <div class="row">
                    <div class="col-auto">
                        <div class="slider-three__content">
                            ...
                            <form class="slider-three__search">
                                <input type="text" id="search1" placeholder="Search courses">
                                <button type="submit" id="searchButton" onclick="return false, search()"><i class="kipso-icon-magnifying-glass"></i>
        ...
        <section class="course-one home-three">
            <img src="/assets_homepage/assets/images/line-stripe.png" class="course-one__line" alt="">
            <div class="container">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active  animated fadeInUp" role="tabpanel" id="overview">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <img src="/assets_homepage/assets/images/teacher-h3-1-1.jpg" alt="">
                            </div><!-- /.col-lg-6 -->
                        </div><!-- /.row -->
                    ...
                    <div class="tab-pane  animated fadeInUp" role="tabpanel" id="curriculum">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <img src="/assets_homepage/assets/images/teacher-h3-1-2.jpg" alt="">
                            </div><!-- /.col-lg-6 -->
                        </div><!-- /.row -->
                    </div><!-- /.course-details__tab-content -->
                </div><!-- /.tab-content -->
        ...
        <section class="cta-six thm-gray-bg">
            <img src="/assets_homepage/assets/images/line-stripe-2.png" class="cta-six__line" alt="">
            <div class="container-fluid clearfix">
                <div class="cta-six__left">
                    <div class="cta-six__content">
                        ...
                        <img src="/assets_homepage/assets/images/fact-1-1.jpg" alt="">
                    </div><!-- /.cta-six__content -->
                </div><!-- /.cta-six__left -->
                <div class="cta-six__right">
                    <img src="/assets_homepage/assets/images/fact-1-2.jpg" alt="">
                ...
                <div class="testimonials-one__carousel owl-carousel owl-theme">
                    <div class="item">
                        <div class="testimonials-one__single">
                            <div class="testimonials-one__qoute">
                                <img src="/assets_homepage/assets/images/qoute-1-1.png" alt="">
                            ...
                            <img src="/assets_homepage/assets/images/team-1-1.jpg" alt="" class="testimonials-one__img">
                    ...
                    <div class="item">
                        <div class="testimonials-one__single">
                            ...
                            <img src="/assets_homepage/assets/images/team-1-2.jpg" alt="" class="testimonials-one__img">
                    ...
                    <div class="item">
                        <div class="testimonials-one__single">
                            ...
                            <img src="/assets_homepage/assets/images/team-1-3.jpg" alt="" class="testimonials-one__img">
                    ...
                    <div class="item">
                        <div class="testimonials-one__single">
                            ...
                            <img src="/assets_homepage/assets/images/team-1-4.jpg" alt="" class="testimonials-one__img">
                    ...
                    <div class="item">
                        <div class="testimonials-one__single">
                            ...
                            <img src="/assets_homepage/assets/images/team-1-5.jpg" alt="" class="testimonials-one__img">
                    ...
                    <div class="item">
                        <div class="testimonials-one__single">
                            ...
                            <!-- /.testimonials-one__text -->
                            <img src="/assets_homepage/assets/images/team-1-6.jpg" alt="" class="testimonials-one__img">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="video-three__image">
                                    <img src="/assets_homepage/assets/images/fact-2-1.jpg" class="img-fluid" alt="">
        ...
        <section class="brand-one brand-one__home-three">
            <div class="container">
                <div class="brand-one__carousel owl-carousel owl-theme">
                    <div class="item">
                        <img src="/assets_homepage/assets/images/brand-1-1.png" alt="">
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="/assets_homepage/assets/images/brand-1-1.png" alt="">
                    </div><!-- /.item -->
        ...
        <section class="cta-five">
            <img src="/assets_homepage/assets/images/team-1-1.jpg" class="cta-five__members-1" alt="">
            <img src="/assets_homepage/assets/images/team-1-2.jpg" class="cta-five__members-2" alt="">
            <img src="/assets_homepage/assets/images/team-1-3.jpg" class="cta-five__members-3" alt="">
            <img src="/assets_homepage/assets/images/team-1-4.jpg" class="cta-five__members-4" alt="">
            <img src="/assets_homepage/assets/images/team-1-5.jpg" class="cta-five__members-5" alt="">
            <img src="/assets_homepage/assets/images/team-1-6.jpg" class="cta-five__members-6" alt="">
